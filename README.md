...
- I resorted to relying on my friend's computer which had a gpu to run my code. This meant I have to change the gpu_processing.py file accordingly. 
- So the version you should run is in the main branch while the version that I am using will be on the gpu-processing branch.
